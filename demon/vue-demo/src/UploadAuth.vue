  ...
  <div class="container">
    <div class="setting">
      ...
      <div class="input-control">
        ...
        <input type="text" class="form-control" id="retryDuration" v-model="retryDuration"
          placeholder="输入网络失败重试间隔, 默认2秒">
      </div>
    ...
    <div class="info">uploadAuth及uploadAddress参数请查看<a href="https://help.aliyun.com/document_detail/55407.html"
        target="_blank">获取上传地址和凭证</a></div>
  </div>
</template>
<script>
        ...
        onUploadstarted: function (uploadInfo) {
          ...
          if (!uploadInfo.videoId) {
            ...
            axios.get(createUrl, {
              ...
              headers: {
                Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2MzMxZGU2NWI1NWQ2YzNmZGNmNWNmYTciLCJpYXQiOjE2NjQzNzI2MjAsImV4cCI6MTY2NDk3ODY0NH0.DEH01e56MsegvOL_AAQZoM7qhkSbvHHqJS7iWJycrx8'
              }
            }).then(({ data }) => {
